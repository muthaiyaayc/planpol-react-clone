...
function Navbar() {
    ...
    const typeHeader = () => {
      if (!deleting) {
        ...
        if (charIndex <= 0) {
          ...
          setWordIndex(
            (previousIndex) =>
              (previousIndex + 1) % headerWords.length
          );
  ...
  return (
    <header ref={navbarRef} className="relative z-[1000] flex min-h-[70px] w-full flex-col items-stretch gap-3 bg-white px-[14px] py-3 min-[651px]:min-h-[70px] min-[651px]:flex-row min-[651px]:items-center min-[651px]:justify-between min-[651px]:px-[18px] min-[651px]:py-3 min-[901px]:h-[76px] min-[901px]:min-h-0 min-[901px]:gap-3 min-[901px]:px-[22px] min-[901px]:py-0 min-[1151px]:h-[82px] min-[1151px]:px-[38px] min-[1151px]:py-0 min-[1500px]:h-[90px] min-[1500px]:px-[65px]">
      ...
      <nav ref={menuRef} className="flex h-[45px] w-full max-w-full shrink-0 items-center justify-start gap-[2px] overflow-x-auto rounded-[32px] bg-[#1769ff] px-1 py-[3px] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden min-[651px]:h-[45px] min-[651px]:max-w-[100%] min-[901px]:h-[47px] min-[901px]:max-w-[68%] min-[901px]:rounded-[27px] min-[901px]:px-[5px] min-[901px]:py-[3px] min-[1151px]:h-[52px] min-[1151px]:px-[6px] min-[1151px]:py-1 min-[1500px]:h-[76px] min-[1500px]:max-w-none min-[1500px]:rounded-[40px] min-[1500px]:px-2 min-[1500px]:py-[6px]" aria-label="Main navigation">
        ...
        {navItems.map((item) => (
          <NavLink key={item.path} to={item.path} className={({ isActive }) => `relative z-10 flex h-[39px] shrink-0 items-center justify-center whitespace-nowrap rounded-[27px] px-[13px] text-[12px] font-normal leading-none no-underline transition-[background,transform] duration-200 ease-in-out hover:bg-white/15 ${isActive ? "bg-white" : ""} min-[651px]:h-[39px] min-[651px]:px-[13px] min-[651px]:text-[12px] min-[901px]:h-[41px] min-[901px]:rounded-[23px] min-[901px]:px-[13px] min-[901px]:text-[13px] min-[1151px]:h-[44px] min-[1151px]:rounded-[27px] min-[1151px]:px-[17px] min-[1151px]:text-[16px] min-[1500px]:h-[64px] min-[1500px]:rounded-[34px] min-[1500px]:px-[25px] min-[1500px]:text-[21px]`}>
            {({ isActive }) => (
              <span className="relative z-20 whitespace-nowrap" style={{ color: isActive ? "#1769ff" : "#ffffff" }}>
                {item.name}
              </span>
            )}
          </NavLink>
        ...
        <NavLink to="/contact" className={({ isActive }) => `relative z-10 flex h-[39px] shrink-0 items-center justify-center whitespace-nowrap rounded-[27px] px-[13px] text-[12px] font-normal leading-none no-underline transition-[background,transform] duration-200 ease-in-out hover:-translate-y-px hover:bg-white min-[901px]:h-[41px] min-[901px]:rounded-[23px] min-[901px]:px-4 min-[901px]:text-[13px] min-[1151px]:h-[44px] min-[1151px]:rounded-[27px] min-[1151px]:px-5 min-[1151px]:text-[16px] min-[1500px]:h-[64px] min-[1500px]:rounded-[34px] min-[1500px]:px-7 min-[1500px]:text-[21px]`}>
          {({ isActive }) => (
            <span className="relative z-20 whitespace-nowrap" style={{ color: isActive ? "#1769ff" : "#ffffff" }}>
              Start Trial
            </span>
